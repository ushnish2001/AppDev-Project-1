...
def handle_exception(e):
    ...
    flash("Error!!. Please retry with correct information ")
    return render_template("base.html")


def user_or_librarian():
    if 'username' not in session:
        flash("Please login or register to continue")
        return 'nouser'
    elif session['username']!='librarian':
        return 'notlibrarian'
    else:
        return 'librarian'
...
@myapp.route('/librarian')
def librarianpage():
    c = user_or_librarian()
    if c == 'nouser':
        return userpage()
    else:
        return render_template('librarianpage.html', username=session['username'])
...
def searchbook():
    ...
    if c == 'nouser':
        ...
        return render_template('book_show.html', booklist=booklist, frametitle="Search Books",
...
def showbooks():
    ...
    return render_template('book_show.html', booklist=booklist, frametitle="All Books",
                           username=session['username'])
...
def showmembers():
    ...
    if c=='nouser':
        ...
        flash("Please login with librarian credentials")
        return render_template('login.html')
